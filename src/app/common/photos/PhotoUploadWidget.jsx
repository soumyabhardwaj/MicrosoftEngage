...
const PhotoUploadWidget = ({ setEditMode }) => {
    ...
    const handleUploadImage = () => {
        ...
        }, error => toast.error(error.message), () => uploadTask.snapshot.ref.getDownloadURL().then(downloadURL => {
    ...
    return (
        <Grid>
            ...
            <Grid.Column width={4}>
                ...
                {files.length > 0 && 
                <Fragment>
                    <div className="img-preview" style={{ minHeight: 200, minWidth: 200, overflow: 'hidden' }}></div>
                    <Button.Group>
